                            ...
                            <div class="row border-top py-3 mt-3">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <a href="" class="px-2 font-size-14 font-rale">20.534 ratings</a>
                                    </div>
                                    <!-- !product rating -->

                                    <!-- product qty -->
                                    <div class="qty d-flex pt-2">
                                        <div class="d-flex font-rale w-20">
                        ...
                        <div class="col-sm-3">
                            <div class="sub-total border text-center mt-2">
                                ...
                                <div class="border-top py-4">
                                    ...
                                    <button type="submit" class="btn btn-warning mt-3">Proced To Buy</button>
                                </div>
                            </div>
                        </div>
                        <!-- !subtot section -->
